...
Value checkkernel(const Array& params, bool fHelp)
{
	...
	if (vNodes.empty())
		throw JSONRPCError(-9, "Rampant is not connected!");

	if (IsInitialBlockDownload())
		throw JSONRPCError(-10, "Rampant is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
	...
	if (vNodes.empty())
		throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Rampant is not connected!");

	if (IsInitialBlockDownload())
		throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Rampant is downloading blocks...");
