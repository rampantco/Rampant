...
private slots:
    ...
    QString BuyRCO(QString OrderType, double Quantity, double Rate);
    QString SellRCO(QString OrderType, double Quantity, double Rate);
