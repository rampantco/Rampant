...
private slots:
    ...
    QString BuyRMT(QString OrderType, double Quantity, double Rate);
    QString SellRMT(QString OrderType, double Quantity, double Rate);
